...
public:
    virtual Passenger* createPassenger(std::string&& name, std::string&& surname, std::string&& thirdName, bool&& baggage, bool&& carryOn, std::string&& pasport) = 0; // ћетод дл€ создани€ пассажира
